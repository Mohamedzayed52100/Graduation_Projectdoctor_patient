                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col ml-md-n2 profile-user-info">
                                        ...
                                        <div class="about-text">
                                            <h6>    Welcome Doctor : {{ $doctor->name }}
                                                Specialty : {{ $doctor->speciality}},
                                                Experience: {{ $num_of_exper }} years
                                                You follow up {{ $paient_count }} patients</h6>
                                            
                                        


                                            {{-- patients treated By you you can see them and chat with him and the patient
                                            have Relative you can call them



                                            Specialty: Surgeon, Experience: 3 years. You follow up 5 patients by our system. --}}
